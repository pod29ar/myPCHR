...
<body>
	<div class="wrapper">
		...
		<?php $this->load->view('partial/_cart_tabber');?>
	...
	<?php
	$this->load->view('partial/_mealset_lightbox');
	if (isset($cart)):
		$this->load->view('partial/_cart_popper');
		$this->load->view('partial/_item_detail');
	endif;
	?>
	...
	<?php if (isset($popper) && ! empty($popper)):?>
	var popperSwitch = <?php echo $popper; ?>;
	<?php else: ?>
	var popperSwitch = 0;
	<?php endif; ?>
	</script>
